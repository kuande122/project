...
if option == '中信兄弟':
  ...
  if option1=='球隊成績':
    ...
    plt.xticks(BrothersPitching.年度, [2021,2020,2019,2018,2017,2016,2015,2014]) # 設定x軸label以及垂直顯示
    plt.xticks(UnilionsPitching.年度,[2021,2020,2019,2018,2017,2016,2015,2014] ) # 設定x軸label以及垂直顯示
    plt.xticks(RakutenPitching.年度,[2021,2020,2019,2018,2017,2016,2015,2014]) # 設定x軸label以及垂直顯示
    plt.xticks(GuardiansPitching.年度, [2021,2020,2019,2018,2017,2016,2015,2014]) # 設定x軸label以及垂直顯示
    #plt.xticks(DragonsPitching.年度, [2021]) # 會影響x座標軸數值更動
